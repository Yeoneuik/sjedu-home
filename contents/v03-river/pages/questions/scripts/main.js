window.onload = function() {
    ...
    var anim01 = lottie.loadAnimation( {
        ...
        loop: false,
        autoplay: false,
        path: 'https://assets9.lottiefiles.com/packages/lf20_icug4c47.json'
    })
    ...
    var anim02 = lottie.loadAnimation( {
        ...
        loop: false,
        autoplay: false,
        path: 'https://assets5.lottiefiles.com/packages/lf20_gn7qjdem.json'
    })
    ...
    var anim03 = lottie.loadAnimation( {
        ...
        loop: false,
        autoplay: false,
        path: 'https://assets7.lottiefiles.com/packages/lf20_fbgomf7c.json'
    })
